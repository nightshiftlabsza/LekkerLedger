...
describe("domestic worker payslip page copy", () => {
    it("uses the updated SEO metadata and structured data copy", () => {
        ...
        expect(source).toMatch(/Get your first free domestic worker payslip sample\. Enter the pay details and we’ll email the PDF to you\./);
    ...
    it("uses the tightened hero copy, helper block, and paid bridge", () => {
        ...
        expect(source).toMatch(/Free covers your first emailed payslip sample\./);
