                        ...
                        <Card className="bg-[var(--primary)] /10 border border-[var(--primary)] /20 rounded-2xl">
                            <CardContent className="p-4 flex items-center justify-between gap-4">
                                ...
                                <Link href={`/payroll/${currentPeriod.id}`}>
                                    <Button size="sm" variant="outline" className="h-9 px-4 border-[var(--primary)] text-[var(--primary-hover)] hover:bg-[var(--primary)] hover:text-white transition-all font-bold">
                                        View Payroll
                                    </Button>
                                </Link>
                            </CardContent>
