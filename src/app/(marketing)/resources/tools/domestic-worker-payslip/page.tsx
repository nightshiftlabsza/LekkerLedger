...
export const metadata = {
    ...
    description: "Prepare a domestic worker payslip PDF with the common payment details employers usually need. Payroll figures stay in your browser until download.",
};
