        ...
        <>
            ...
            {periods.length === 0 && (
                <EmptyState
                    ...
                    description={
                        employees.length === 0
                            ? "Add your first employee, then start your monthly payroll."
                            : "Start your first monthly payroll to generate compliant payslips."
                    }
                    actionLabel={employees.length === 0 ? "Add Employee" : `Start ${format(new Date(), "MMMM yyyy")}`}
                    onAction={employees.length === 0 ? () => router.push("/app/employees/new") : handleStartPeriod}
                />
            )}
