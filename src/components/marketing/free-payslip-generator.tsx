    ...
    const handleDownload = React.useCallback(async () => {
        ...
        try {
            ...
            if (!quotaResponse.ok) {
                ...
                throw new Error(typeof quotaData === "object" && quotaData && "error" in quotaData && typeof quotaData.error === "string" ? quotaData.error : "The free monthly limit could not be updated.");
            }
