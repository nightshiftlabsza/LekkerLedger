...
export async function generateCertificateOfService(
    ...
    cy -= 18;
    const text = `The employee was employed as a ${employee.role}. Duties were performed in line with the role recorded by the employer.`;
    ...
    const footerText = "LekkerLedger.app · Generated service record";
