...
export async function generateCertificateOfService(
    ...
    const sealY = 80;
    page.drawCircle({ x: sealX, y: sealY, size: 25, color: rgb(0.95, 0.95, 0.95), borderColor: AMBER, borderWidth: 1 });
    page.drawText("BCEA", { x: sealX - 8, y: sealY + 4, size: 6, font: bold, color: AMBER });
    page.drawText("SEC 42", { x: sealX - 8, y: sealY - 4, size: 4, font: regular, color: SLATE });
