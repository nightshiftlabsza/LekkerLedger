...
export async function generateEmploymentContract(
    ...
    const addPage = () => {
        ...
        const footerText = "LekkerLedger.app · Generated employment record";
    ...
    p1.drawText("Domestic worker employment agreement", {
    ...
    row(p1, "National Minimum Wage (NMW)", `R ${nmw.toFixed(2)} per hour (reference for the effective date)`, cy); cy -= 18;
    ...
    row(p1, "Sunday / PH Rate", "2.0x ordinary (Sectoral Determination 7 (SD7) S.6–7)", cy); cy -= 18;
    ...
    p2.drawText("Generated by LekkerLedger", {
