...
const TRANSLATIONS: Record<SupportLang, Record<string, string>> = {
    en: {
        ...
        sick: "Sick",
        family: "Family",
        legalDisclaimer: "Generated by LekkerLedger using the pay inputs provided.",
        minWage: "Min Wage",
        proudlySA: "South African Domestic Standard",
        generated: "GENERATED",
        byLekkerLedger: "BY LEKKERLEDGER"
    },
    zu: {
        ...
        sick: "Lokugula",
        family: "Lomndeni",
        legalDisclaimer: "Kwenziwe yi-LekkerLedger kusetshenziswa imininingwane yokukhokha enikeziwe.",
        minWage: "Iholo elincane",
        proudlySA: "Kwenziwe eNingizimu Afrika",
        generated: "KUKHIQIWE",
        byLekkerLedger: "NGE-LEKKERLEDGER"
    },
    xh: {
        ...
        sick: "Yokugula",
        family: "Yosapho",
        legalDisclaimer: "Yenziwe yiLekkerLedger kusetyenziswa iinkcukacha zomvuzo ezifakiweyo.",
        minWage: "Umvuzo ophantsi",
        proudlySA: "Yenziwe eMzantsi Afrika",
        generated: "YENZIWE",
        byLekkerLedger: "NGELEKKERLEDGER"
    }
};
...
export async function generatePayslipPdfBytes(
    ...
    t(dict.generated, markX + 45, markY + 14, { font: sansBold, size: 6, color: PDF_COLORS.PRIMARY_GREEN, align: "right" });
    t(dict.byLekkerLedger, markX + 45, markY + 6, { font: sansBold, size: 4.5, color: PDF_COLORS.TEXT_MUTED, align: "right" });
