...
export async function generatePayslipPdfBytes(
    ...
    let cy = drawParties(page, width, headerY, dict, employee, settings, templateData, sansBold, sansRegular, t);
    cy = drawEarningsTable(page, width, cy, dict, payslip, breakdown, sansBold, sansRegular, t, drawLine);
    cy = drawDeductionsTable(page, width, cy, dict, payslip, breakdown, sansBold, t, drawLine);
    drawNetPaySummary(page, width, cy, templateData, breakdown, serifBold, sansBold, t);
