...
## Required Inputs
- **Target Persona:** (e.g., Practitioner vs. Homeowner).
- **Core Action:** (e.g., Saving a payslip, Viewing an audit).
...
**Goal:** Legal safety (BCEA/SD7), POPIA/GDPR data privacy, and App Store guidelines.
**Mentor Hard Truth:** Is user data (IDs, PII) leaking in logs or plain text? Are we breaking local labor laws?
...
- [ ] **Legal:** Verified against latest statutory constants.
- [ ] **Instrumentation:** Identified at least 1 tracking point for the funnel.
