...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "var(--bg-base)" }}>
      {/* Header */}
      <header
        className="sticky top-0 z-30 px-6 py-4 flex items-center justify-between glass-panel"
        style={{
      ...
      >
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-4">
            <img src="/brand/logo-light.png" alt="LekkerLedger Logo" className="h-10 w-auto" />
          </div>
          <nav className="hidden md:flex items-center gap-6">
            <Link href="/pricing" className="text-sm font-medium hover:text-[var(--amber-500)] transition-colors" style={{ color: "var(--text-secondary)" }}>
              Pricing
            </Link>
            <Link href="/rules" className="text-sm font-medium hover:text-[var(--amber-500)] transition-colors" style={{ color: "var(--text-secondary)" }}>
              SA Rules Guide
            </Link>
            <a href="mailto:nightshiftlabsza@gmail.com" className="text-sm font-medium hover:text-[var(--amber-500)] transition-colors" style={{ color: "var(--text-secondary)" }}>
              Support
            </a>
          </nav>
        </div>
        <div className="flex items-center gap-3">
          <Button size="default" variant="default" onClick={handleStart} className="font-bold">
            Get Started
          </Button>
        </div>
      </header>
      ...
      {/* Hero */}
      <main className="flex-1 px-5 py-16 sm:py-24 max-w-7xl mx-auto w-full">
