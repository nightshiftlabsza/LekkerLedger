...
import { ArrowRight, Shield, Clock, Github, AlertTriangle, ShieldCheck, Sparkles, ChevronRight, Star, FileText, CheckCircle2 } from "lucide-react";
                    ...
                    <div className="space-y-8 w-full animate-slide-up text-center lg:text-left">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start pt-2">
                            <div className="flex flex-col items-center sm:items-start gap-1">
                                <Button size="lg" className="w-full sm:w-auto gap-2 font-bold px-8 h-14 rounded-2xl bg-amber-500 text-white" onClick={() => handleStart()}>
                                    Manage Employees <ArrowRight className="h-5 w-5" />
                                </Button>
                                <div className="flex items-center gap-1 text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-wide">
                                    <CheckCircle2 className="h-3 w-3 text-green-500" /> Free forever <span className="mx-1">•</span> Pro from R79/mo
                                </div>
                            </div>
                        </div>
                        ...
                        {/* UP-1: Social Proof Row */}
                        <div className="flex flex-wrap items-center gap-4 pt-4 animate-fade-in">
                            <div className="flex items-center gap-1 text-amber-500">
                                {[...Array(5)].map((_, i) => <Star key={i} className="h-4 w-4 fill-current" />)}
                            </div>
                            <p className="text-xs font-bold text-[var(--text-muted)]">Trusted by 500+ SA homeowners</p>
                            <div className="flex items-center gap-1.5 px-2 py-1 rounded bg-green-500/10 text-green-600 text-[10px] font-black tracking-widest uppercase">
                                <ShieldCheck className="h-3.5 w-3.5" /> POPIA Compliant
                            </div>
                        </div>
                ...
                <div className="mt-24 w-full max-w-4xl mx-auto space-y-12 animate-slide-up">
                    ...
                    <div className="grid sm:grid-cols-3 gap-8">
                        {[
                            ...
                            {
                                title: "uFiling Ready Exports",
                                desc: "Generate monthly UI-19 forms and bulk export files formatted exactly for the Department of Labour's uFiling portal.",
                                icon: FileText,
                                color: "#3b82f6" // blue-500 equivalent for var injection
                            },
                            {
