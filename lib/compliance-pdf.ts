...
export async function generateCertificateOfServicePdf(
    ...
    // Footer
    t("Generated by LekkerLedger.app - Compliant with South African Labor Law", 48, 40, 7, regular, SLATE);
...
export async function generateBCEASummaryPdf(
    ...
    cy -= 40;
    t("DECLARATION", 48, cy, 10, bold, AMBER);
    cy -= 20;
    const decl = "This document confirms that the associated payslip has been calculated according to the regulations set forth in Sectoral Determination 7 for Domestic Workers in South Africa. The employer confirms the accuracy of the hours and deductions recorded.";
