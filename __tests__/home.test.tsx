...
describe("Home page", () => {
    it("renders the rebuilt homepage flow", async () => {
        ...
        expect(screen.getByRole("heading", { name: /run monthly domestic worker admin without guessing the figures/i })).toBeTruthy();
        expect(screen.getByRole("heading", { name: /start with one free payslip sample, then keep the full month together/i })).toBeTruthy();
